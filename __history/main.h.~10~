...
#define REG_DEV_CONFIG                    21
   ...
   #define REG_IR_CMD_LEN                    22
   #define REG_IR_MANUAL_ON_CODE_HBYTE       23
   #define REG_IR_MANUAL_ON_CODE_LBYTE       24
   #define REG_IR_MANUAL_OFF_CODE_HBYTE      25
   #define REG_IR_MANUAL_OFF_CODE_LBYTE      26
   #define REG_IR_HKEEPING_ON_CODE_HBYTE     27
   #define REG_IR_HKEEPING_ON_CODE_LBYTE     28
   #define REG_IR_HKEEPING_COMPLETE_CODE_HBYTE     29
   #define REG_IR_HKEEPING_COMPLETE_CODE_LBYTE     30
   #define REG_IR_HKEEPING_DURATION          31
#endif
...
// Motor Pin Mappings
   ...
   #define PIC_TRIS_A   0b00111111  // A0,1,2,3,5 are Analog inputs
